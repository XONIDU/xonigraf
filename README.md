...
🎮 Cómo usar
    ...
    Ingresa tu función en el campo de texto usando sintaxis de Python/sympy.

    Define el rango X en formato min,max (ej: -10,10).

    Presiona Enter o el botón "Graficar" para ver el resultado.
